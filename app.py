...
def encode(plaintext, rotors, ringSettings, ringPositions, plugboard):
...
def gfg():
    if request.method == "POST":
       ...
       print(input_text['rotor_values'])
       print(input_text['ring_settings'])
       print(input_text['ring_positions'])
       print(input_text['plugboard'])
       rotors = str(input_text['rotor_values'])
       rotors = rotors.replace(' ', '')
       rotors = rotors.split(",")
       return encode(input_text['input'], rotors, input_text['ring_settings'], input_text['ring_positions'], input_text['plugboard'])
